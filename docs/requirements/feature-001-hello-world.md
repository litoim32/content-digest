...
As a developer setting up this project, I want the app to render a greeting that
includes the project name, so I can confirm the build, dev server, and component
...
- GIVEN the project name
  ...
  THEN I see an `<h1>` element containing "Welcome to webapp".
